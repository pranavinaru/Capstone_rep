SELECT
    ...
    -- timestamps
    TO_TIMESTAMP(o.value:order_date::STRING)              AS order_date,
    TO_TIMESTAMP(o.value:created_at::STRING)              AS created_at,
    TO_TIMESTAMP(o.value:delivery_date::STRING)           AS delivery_date,
    TO_TIMESTAMP(o.value:estimated_delivery_date::STRING) AS estimated_delivery_date,
    TO_TIMESTAMP(o.value:shipping_date::STRING)           AS shipping_date,
 
    -- financials
    o.value:tax_amount::FLOAT          AS tax_amount,
    o.value:shipping_cost::FLOAT       AS shipping_cost,
    o.value:discount_amount::FLOAT     AS order_discount,
    ...
    i.value:discount_amount::FLOAT  AS item_discount
